		...
		<div class="container">
			...
			<div class="row">
				...
				<div class="col-lg-4 me-auto">
					<p class="lead">This website is taken from Internet for implementing
					Backend in Java. It provides Login and sign up functionality. It is 
					connected with MySql database and store Users' data in the database!</p>
				</div>
			</div>
